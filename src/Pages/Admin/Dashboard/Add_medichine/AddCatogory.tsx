        ...
        <div className="col-lg-6">
          <FormikProvider value={Formik}>
            <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
              <TextField label="Catogory Name" name="catogary" type="text" placeholder="Enter the category name" />
              <TextField label="Quantity" name="quantity" type="text" placeholder="Enter the Quantity" />
