  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6">
              ...
              <p>
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Facere ex, est, inventore
                perspiciatis soluta similique adipisci voluptates eos itaque laboriosam provident
              </p>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-lg-4 box text-center mt-2">
              ...
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea dolorem ipsam, earum
                doloribus.
              </p>
      ...
      <section id="pharm" className="mt-4">
        ...
        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Numquam tempora veniam odit quam
          aliquam esse id ut Lorem ipsum dolor sit amet consectetur, adipisicing elit. Numquam
            ...
            <div className="col-lg-6">
              <div className="row">
                <div className="col-lg-2">
                  <img src={brainImg} className="img-fluid float-start" width="80px" alt="img" />
                </div>
                <div className="col-lg-8">
                  <h3 className="">NEUROLOGY</h3>
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat odio voluptas
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-lg-2">
                  <img src={Kidney} className="img-fluid float-start" width="80px" alt="img" />
                </div>
                <div className="col-lg-8">
              ...
              <div className="row">
                <div className="col-lg-2">
                  <img src={heart} className="img-fluid float-start" width="80px" alt="img" />
                </div>
                <div className="col-lg-8">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <h1>care of heart</h1>
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Officia, illo iusto culpa
                architecto quae error. Nobis illum voluptates nemo qui ullam sapiente pariatur
                libero. Rem nihil blanditiis voluptates dolorem a. Lorem ipsum, dolor sit amet
                consectetur adipisicing elit. Officia, illo iusto culpa architecto quae error. Nobis
                illum voluptates nemo qui ullam sapiente pariatur libero. Rem nihil blanditiis
                voluptates dolorem a.
              </p>
              <button className="button d-flex justify-content-center mx-auto">Read More</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mt-5" id="wecare">
        <h1>we care</h1>
        <p>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis odio labore maxime
          reiciendis doloremque libero earum porro, dolorem doloribus? Sint reiciendis doloremque
          libero earum porro, dolorem doloribus? Sint
        </p>
