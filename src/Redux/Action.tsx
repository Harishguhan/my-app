...
export const loadData = () => {
  return function (dispatch: AppDispatch) {
    axios
      .get(`${process.env.REACT_APP_PHARMACY_PRODUCT_API}`)
      .then((responce) => {
...
export const deletData = (id: number) => {
  return function (dispatch: AppDispatch) {
    axios
      .delete(`${process.env.REACT_APP_PHARMACY_PRODUCT_API}/${id}`)
...
export const AddData = (values: Editvalue) => {
  return function (dispatch: AppDispatch) {
    axios
      .post(`${process.env.REACT_APP_PHARMACY_PRODUCT_API}`, values)
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      .then((_responce) => {
        dispatch(Add_New());
      })
...
export const Update = (details: Editvalue, id: number) => {
  return function (dispatch: AppDispatch) {
    axios
      .put(`${process.env.REACT_APP_PHARMACY_PRODUCT_API}/${id}`, details)
      // eslint-disable-next-line @typescript-eslint/no-unused-vars
      .then((_responce) => {
...
export const getSingleUser = (updatevalue: Editvalue) => {
  ...
  return function (dispatch: AppDispatch) {
    axios
      .put(`${process.env.REACT_APP_PHARMACY_PRODUCT_API}/${updatevalue.id}`, updatevalue)
      .then((responce) => {
